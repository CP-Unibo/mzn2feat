...
/*
* NOTE:   FlatZinc parser modified in order to extract static features.
...
//FIXME: Extended maximum stack depth for dealing with huge instances, but 
//       this may be a bad thing (possible undefined beahviours?).
//       (Roberto Amadini)
